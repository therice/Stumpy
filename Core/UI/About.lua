...
function AddOn:AddAbout()
	if not self.about then
		...
		local index, about = lpad:AddModule(AddOn.name, UIUtil.ColoredDecorator(C.Colors.White):decorate(AddOn.name))
		about.image = UI:New('Texture', about, BaseWidget.ResolveTexture("stumpy")):Point("TOPLEFT",15,5):Size(512, 320)
